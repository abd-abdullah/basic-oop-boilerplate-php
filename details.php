...
?>
<?php 
    $all_user = $Query->GetAll("user");
    $data = mysqli_fetch_all($all_user,MYSQLI_ASSOC);
 ?>
                    ...
                    <tbody>
                        ...
                        <form  method="post" action="">
                            ...
                            <td><?php echo  $value['country']; ?></td>
                                 <td class="center">
                    <a href="?del_id=<?php echo $value['user_id']; ?>" class="btn btn-xs btn-danger" type="submit" name="delete" onclick="return confirmation()">
                    <span class="glyphicon glyphicon-trash"></span>
                    </a>
                        <input type="hidden" name="user_id" value="<?php echo $value['user_id']; ?>">
                        
                    <a class="btn btn-xs btn-info" href="/../pattern/edit.php?id=<?php echo $value['user_id']; ?>">
